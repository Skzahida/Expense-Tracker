...
public class ViewExpense extends javax.swing.JFrame {
 ...
 try{
    ...
    private void initComponents() {
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jButton1, ta, totalAmount1});

        jPanel3.setBackground(new java.awt.Color(153, 251, 193));
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {category, jLabel11});
        ...
        getAccessibleContext().setAccessibleName("View Expenses");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        java.sql.Date dt2 =  new java.sql.Date(d2.getDate().getTime());
         Connection c= DriverManager.getConnection("jdbc:mysql://localhost/expensedb?allowPublicKeyRetrieval=true&useSSL=false","root","Sadaf@786");
            Statement s = c.createStatement();
            ResultSet rs =s.executeQuery("select * from expenses where sdate>='"+dt1+"' and sdate<='"+dt2+"' order by sdate asc");
        int total=0;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        java.sql.Date dt2 =  new java.sql.Date(dd2.getDate().getTime());
         Connection c= DriverManager.getConnection("jdbc:mysql://localhost/expensedb?allowPublicKeyRetrieval=true&useSSL=false","root","Sadaf@786");
            Statement s = c.createStatement();
            ResultSet rs =s.executeQuery("select * from expenses where sdate>='"+dt1+"' and sdate<='"+dt2+"' and category = '"+c1+"' order by sdate asc");
        int total=0;
